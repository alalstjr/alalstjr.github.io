...
행사는 2024년 9월 12일 삼성역 코엑스에서 열렸습니다. 비가 많이 내리는 날이었음에도 불구하고, 정말 많은 사람들이 행사에 참석했어요.
...
![No Limit 팜플렛](/assets/img/2024-10-05-2.jpg){: .dark .normal w='380' h='140' }
![No Limit 키링](/assets/img/2024-10-05-3.png){: .dark .normal w='380' h='140' }
![No Limit 참석 인증](/assets/img/2024-10-05-4.jpg){: .dark .normal w='380' h='140' }
![No Limit 현장 분위기](/assets/img/2024-10-05-5.jpg){: .dark .normal w='380' h='140' }
...
당시 제가 듣고 기록한 내용을 간략하게 요약하고 저의 생각을 짧게 작성해보았어요.

### 리플레이 검증으로 새로운 금융 시스템 안전하게 도입하기

![No Limit](/assets/img/2024-10-05-6.jpg){: .dark .normal w='380' h='140' }
...
저는 그저 기획서를 보고 "미래에 발생할 오류는 생각하지 않고 빨리 개발을 끝내야겠다"는 생각만 했던 제 자신을 반성하게 되는 시간이었어요.

### CPU Observability 높이는 Hyperthread 톺아보기

![No Limit](/assets/img/2024-10-05-7.jpg){: .dark .normal }
...
![No Limit](/assets/img/2024-10-05-8.jpg){: .dark .normal }
...
![No Limit](/assets/img/2024-10-05-9.jpg){: .dark .normal }

토스 개발자들이 `자신들이 맡은 프로젝트에 얼마나 많은 애정과 진심`을 쏟았는지를 알 수 있는 시간이었으며, 
왜 `많은 사람들이 토스를 이용하는지 이해`하게 되었습니다.  
또한, `토스의 무료 환전 시스템을 최초로 구축하는 데 얼마나 많은 시간과 노력`이 들어갔는지 가늠할 수 없었습니다.   
...
이 글을 읽고 있는 개발자인 당신도 별거 아닌 프로젝트라고 하더라도 `자신의 모든 것을 걸고 개발하여 모두가 인정하는 프로젝트를 만들어가는 그날까지 같이 성장`해봅시다.
